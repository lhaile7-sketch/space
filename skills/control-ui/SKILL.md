...
There is a web-based Setup UI at `https://openclaw-railway-template-production-7207.up.railway.app`. The **user** manages runtime configuration through it. You should NOT call these API endpoints yourself or write config files directly — instead, tell the user what they need to do and where to do it.
...
> You can add that in your Setup UI → **Envars** tab: https://openclaw-railway-template-production-7207.up.railway.app#envars

### Connecting a new channel (Telegram, Discord)

> Add your bot token in the Setup UI → **Envars** tab (https://openclaw-railway-template-production-7207.up.railway.app#envars), then approve the pairing request in the **General** tab (https://openclaw-railway-template-production-7207.up.railway.app#general).

### Approving or rejecting pairings

When a user asks about pairing their Telegram or Discord account:

> Open the Setup UI → **General** tab (https://openclaw-railway-template-production-7207.up.railway.app#general). Pending pairing requests appear automatically — click **Approve** or **Reject**.

### Connecting OpenAI Codex OAuth

> Connect or reconnect Codex OAuth from the Setup UI → **Providers** tab (https://openclaw-railway-template-production-7207.up.railway.app#providers). Click **Connect Codex OAuth** and follow the popup flow.

### Connecting Google Workspace

> Set up Google Workspace from the Setup UI → **General** tab (https://openclaw-railway-template-production-7207.up.railway.app#general, Google section). You'll need your OAuth client credentials from Google Cloud Console.
